...
from sgl_kernel  import moe_permute, moe_unpermute
...
def torch_permute(
    ...
    expert_first_token_offset = torch.zeros(n_expert + 1,
                                            dtype=torch.int64,
                                            device="cuda")
    idx = 0
